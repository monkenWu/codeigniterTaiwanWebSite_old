...
<title><?= $pagetitle ?></title>
    ...
    <body>
		...
		<nav class="navbar navbar-expand-lg fixed-top navbar-dark nav-pills" id="mainnav" role="navigation" style="background-color: #dd4814;">
			<div class="container">
				<a class="navbar-brand" href="/">Code<strong>Igniter</strong>台灣</a>
		...
		<div class="footer">
			...
			<div class="footer-copyright">
				<div class="container">
					<div class="row">
                        <p class="text-left">
							CodeIgniter was created by <a href="http://www.ellislab.com/">EllisLab</a>,
                            fostered by <a href="http://www.bcit.ca/cas/computing/">BCIT</a>,
                            and is a project of the CodeIgniter Foundation.
							<a href="mailto:admin@codeigniter.com"><span class="glyphicon glyphicon-envelope"></span></a>
							<br>
							CodeIgniter台灣 由高雄師範大學軟體工程與管理學系 SDPM 實驗室譯製與維護
						</p>
					</div>
				</div>
			</div>
