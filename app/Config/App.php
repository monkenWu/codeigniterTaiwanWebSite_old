...
class App extends BaseConfig
{
	...
	public $footerChoices = [
		'menudata' => [
			['name' => 'bottomNav1', 'link' => 'https://codeigniter.com/help'],
			['name' => 'bottomNav2', 'link' => 'https://codeigniter.com/help/legal'],
			['name' => 'bottomNav3', 'link' => 'https://codeigniter.com/help/about'],
			['name' => 'bottomNav4', 'link' => 'https://codeigniter.com/']
		]
	];
	...
	/*
	  ...
	  |
	 */
	public $baseURL = 'https://codeigniter.com';
